...
class _AppInitializerState extends State<AppInitializer> {
  ...
  @override
  void initState() { super.initState(); _initializeApp(); }
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: const Center(child: Text('T', style: TextStyle(fontSize: 64, fontWeight: FontWeight.bold, color: AppColors.primary))),
                ),
                const SizedBox(height: 24),
                const Text('TEXORA', style: TextStyle(fontSize: 36, fontWeight: FontWeight.w800, color: Colors.white)),
                ...
                SizedBox(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(_loadingText, style: TextStyle(color: Colors.white.withOpacity(0.9), fontSize: 13), textAlign: TextAlign.center),
                    ],
                  ),
                ),
              ],
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.category_outlined), label: 'Katalog'),
          BottomNavigationBarItem(icon: Icon(Icons.shopping_cart_outlined), label: 'Savat'),
          BottomNavigationBarItem(icon: Icon(Icons.favorite_border_rounded), label: 'Sevimlilar'),
